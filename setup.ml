...
(* OASIS_START *)
(* DO NOT EDIT (digest: f4ebefca13ad81247cb7d7e2366b0f15) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "erm_scheduler"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ermine/scheduler.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/scheduler";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some ")ÒYñÅE’ØT:Nœ\030›Øž";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
